...
a=0
z=1
w3 = Web3(Web3.HTTPProvider("https://mainnet.infura.io/v3/534bb9553f5a4d1e855a53197c227680"))
...
while a<=10000000:
    ...
    print(f"{red}{'=' * 29}[{reset}{white}Scan-V11{reset}:{yellow}{z}{reset}{red}]{'=' * 29}{reset}")
