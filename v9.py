...
a=0
z=1
w3 = Web3(Web3.HTTPProvider("https://mainnet.infura.io/v3/879abd7b02e2420f86587625ee7be822"))
...
while a<=10000000:
    ...
    print(f"{red}{'=' * 29}[{reset}{white}Scan-V9{reset}:{yellow}{z}{reset}{red}]{'=' * 29}{reset}")
