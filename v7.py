...
a=0
z=1
w3 = Web3(Web3.HTTPProvider("https://mainnet.infura.io/v3/fd72f605f5df4777a61a86e821e7f001"))
...
while a<=10000000:
    ...
    print(f"{red}{'=' * 29}[{reset}{white}Scan-V7{reset}:{yellow}{z}{reset}{red}]{'=' * 29}{reset}")
